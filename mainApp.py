...
diabetes_model_1 = pickle.load(open(r'C:\Users\Uttam Rajput\Downloads\Compressed\Manifold_Disease_Prediction_Using_Machine_Learning-main\Module_2\model1.sav', 'rb'))
diabetes_model_2 = pickle.load(open(r'C:\Users\Uttam Rajput\Downloads\Compressed\Manifold_Disease_Prediction_Using_Machine_Learning-main\Module_2\model2.sav', 'rb'))
diabetes_model_3 = pickle.load(open(r'C:\Users\Uttam Rajput\Downloads\Compressed\Manifold_Disease_Prediction_Using_Machine_Learning-main\Module_2\model3.sav', 'rb'))
diabetes_model_final = pickle.load(open(r'C:\Users\Uttam Rajput\Downloads\Compressed\Manifold_Disease_Prediction_Using_Machine_Learning-main\Module_2\model_final.sav', 'rb'))

symptom_model_1 = pickle.load(open(r'C:\Users\Uttam Rajput\Downloads\Compressed\Manifold_Disease_Prediction_Using_Machine_Learning-main\Module_1\model1.sav', 'rb'))

heart_model_1 = pickle.load(open(r'C:\Users\Uttam Rajput\Downloads\Compressed\Manifold_Disease_Prediction_Using_Machine_Learning-main\Module_3\model1.sav', 'rb'))
heart_model_2 = pickle.load(open(r'C:\Users\Uttam Rajput\Downloads\Compressed\Manifold_Disease_Prediction_Using_Machine_Learning-main\Module_3\model2.sav', 'rb'))
heart_model_3 = pickle.load(open(r'C:\Users\Uttam Rajput\Downloads\Compressed\Manifold_Disease_Prediction_Using_Machine_Learning-main\Module_3\model3.sav', 'rb'))
heart_model_final = pickle.load(open(r'C:\Users\Uttam Rajput\Downloads\Compressed\Manifold_Disease_Prediction_Using_Machine_Learning-main\Module_3\model_final.sav', 'rb'))
